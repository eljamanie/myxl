...
def show_hot_menu_combined():
    ...
    while in_bookmark_menu:
        clear_screen()
        print("=======================================================")
        print("================🔥 Paket Hot Gabungan 🔥===============")
        print("=======================================================")
        
        combined_packages = load_hot_combined()

        for idx, p in enumerate(combined_packages):
            if p["type"] == "hot1":
        ...
        if choice == "00":
            ...
            return None
        if choice.isdigit() and 1 <= int(choice) <= len(combined_packages):
            selected = combined_packages[int(choice) - 1]
            if selected["type"] == "hot1":
